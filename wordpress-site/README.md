...
This directory contains the standalone WordPress project and custom **First Theme** for the magazine-style homepage. It is isolated from the other trading-related files in the repository so you can work on the site independently.

## Getting started
1. Install WordPress in this folder (or point an existing local WordPress install to use `wp-content` here).
2. Activate the **First Theme** from the WordPress admin.
...
## Structure
- `wp-content/themes/first-theme/` – theme templates, styles, and scripts
